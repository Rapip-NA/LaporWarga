            ...
            <div class="card-body py-4 px-4">
                <div class="d-flex align-items-center">
                    <div class="avatar avatar-xl">
                        <img src="https://i.pinimg.com/736x/59/43/42/59434262f81cc9f906c97cc25afbd889.jpg" alt="Face 1">
                    </div>
                    <div class="ms-3 name">
                        <h5 class="font-bold">RapipAja</h5>
                        <h6 class="text-muted mb-0">@rapip_na19</h6>
                    </div>
                </div>
            </div>
        </div>
